...
public class OctaveMarkDetectorTest {
    ...
    @Test public void ocrSuppliedParenthesizedSpanRaisesEveryCoveredNote(){var g=page();dash(g,120,370,55);var n=apply(g,List.of(word("(8va)--------",80,40)),List.of(note(150,0),note(300,0),note(500,0)));assertEquals(List.of(1,1,0),n.stream().map(ScoreNoteEvent::octaveShift).toList());}
