...
/** Original returning arcs with clearance for a dot beside the first head. */
public class LongTieClearanceTest {
    private boolean arc(int mode,boolean below)throws Exception {
        int w=260,h=160,left=40,right=180,first=61,last=174;float cy=80,gap=15;
